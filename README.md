...
14. **definire i nodi worker** del cluster nel file **/hadoop/workers**
    ...
    datanode1
    ```
15. **copiare** i file di configurazione di hadoop nel nodo **worker** `datanode1`
...
Fare riferimento alla seguente  [guida](https://medium.com/@redswitches/how-to-install-spark-on-ubuntu-965266d290d6)
